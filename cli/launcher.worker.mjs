...
async function invokeTsLocally() {
    ...
    const tsConfigRegister = `-r ./node_modules/povery-cli/cli/tsconfig-paths-bootstrap.js`;

    const tsNodeDev = `ts-node ${debuggerOptions} ${tsConfigRegister} --transpileOnly -e '${code}' `;
